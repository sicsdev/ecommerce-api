 ...
 * `src/v11/campaign_experiment_service_client_config.json`.
...
class CampaignExperimentServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createCampaignExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v11.services.CreateCampaignExperimentMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.CampaignExperimentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignExperimentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.CampaignExperimentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.CampaignExperimentService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignExperimentServiceStubMethods = ['createCampaignExperiment', 'mutateCampaignExperiments', 'graduateCampaignExperiment', 'promoteCampaignExperiment', 'endCampaignExperiment', 'listCampaignExperimentAsyncErrors'];
    ...
    async checkCreateCampaignExperimentProgress(name) {
        ...
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createCampaignExperiment, this._gaxModule.createDefaultBackoffSettings());
    ...
    async checkPromoteCampaignExperimentProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.promoteCampaignExperiment, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
     ...
     */
    close() {
        if (this.campaignExperimentServiceStub && !this._terminated) {
