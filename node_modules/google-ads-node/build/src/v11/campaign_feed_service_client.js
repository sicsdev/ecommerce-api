 ...
 * `src/v11/campaign_feed_service_client_config.json`.
...
class CampaignFeedServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.CampaignFeedService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignFeedServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.CampaignFeedService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.CampaignFeedService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignFeedServiceStubMethods = ['mutateCampaignFeeds'];
     ...
     */
    close() {
        if (this.campaignFeedServiceStub && !this._terminated) {
