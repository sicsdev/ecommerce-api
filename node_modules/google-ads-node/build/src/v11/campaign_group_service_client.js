...
exports.CampaignGroupServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v11/campaign_group_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./campaign_group_service_client_config.json");
...
class CampaignGroupServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.CampaignGroupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.campaignGroupServiceStub) {
            return this.campaignGroupServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v11.services.CampaignGroupService.
        this.campaignGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.CampaignGroupService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.CampaignGroupService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignGroupServiceStubMethods = ['mutateCampaignGroups'];
        for (const methodName of campaignGroupServiceStubMethods) {
            const callPromise = this.campaignGroupServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateCampaignGroups(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    close() {
        if (this.campaignGroupServiceStub && !this._terminated) {
            return this.campaignGroupServiceStub.then(stub => {
...
exports.CampaignGroupServiceClient = CampaignGroupServiceClient;
//# sourceMappingURL=campaign_group_service_client.js.map