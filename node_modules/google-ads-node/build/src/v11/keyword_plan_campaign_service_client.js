 ...
 * `src/v11/keyword_plan_campaign_service_client_config.json`.
...
class KeywordPlanCampaignServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.KeywordPlanCampaignService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanCampaignServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.KeywordPlanCampaignService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.KeywordPlanCampaignService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordPlanCampaignServiceStubMethods = ['mutateKeywordPlanCampaigns'];
     ...
     */
    close() {
        if (this.keywordPlanCampaignServiceStub && !this._terminated) {
