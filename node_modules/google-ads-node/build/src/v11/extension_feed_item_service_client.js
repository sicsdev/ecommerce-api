 ...
 * `src/v11/extension_feed_item_service_client_config.json`.
...
class ExtensionFeedItemServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.ExtensionFeedItemService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.extensionFeedItemServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.ExtensionFeedItemService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.ExtensionFeedItemService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const extensionFeedItemServiceStubMethods = ['mutateExtensionFeedItems'];
     ...
     */
    close() {
        if (this.extensionFeedItemServiceStub && !this._terminated) {
