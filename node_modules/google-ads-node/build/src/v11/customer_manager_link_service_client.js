 ...
 * `src/v11/customer_manager_link_service_client_config.json`.
...
class CustomerManagerLinkServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.CustomerManagerLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerManagerLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.CustomerManagerLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.CustomerManagerLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerManagerLinkServiceStubMethods = ['mutateCustomerManagerLink', 'moveManagerLink'];
     ...
     */
    close() {
        if (this.customerManagerLinkServiceStub && !this._terminated) {
