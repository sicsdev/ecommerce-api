 ...
 * `src/v11/customer_feed_service_client_config.json`.
...
class CustomerFeedServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.CustomerFeedService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerFeedServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.CustomerFeedService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.CustomerFeedService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerFeedServiceStubMethods = ['mutateCustomerFeeds'];
     ...
     */
    close() {
        if (this.customerFeedServiceStub && !this._terminated) {
