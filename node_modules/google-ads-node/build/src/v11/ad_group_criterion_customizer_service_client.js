 ...
 * `src/v11/ad_group_criterion_customizer_service_client_config.json`.
...
class AdGroupCriterionCustomizerServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.AdGroupCriterionCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupCriterionCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.AdGroupCriterionCustomizerService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.AdGroupCriterionCustomizerService, this._opts, this._providedCustomServicePath);
     ...
     */
    close() {
        if (this.adGroupCriterionCustomizerServiceStub && !this._terminated) {
