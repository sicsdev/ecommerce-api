...
exports.AssetGroupSignalServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v11/asset_group_signal_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./asset_group_signal_service_client_config.json");
...
class AssetGroupSignalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.AssetGroupSignalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.assetGroupSignalServiceStub) {
            return this.assetGroupSignalServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v11.services.AssetGroupSignalService.
        this.assetGroupSignalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.AssetGroupSignalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.AssetGroupSignalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const assetGroupSignalServiceStubMethods = ['mutateAssetGroupSignals'];
        for (const methodName of assetGroupSignalServiceStubMethods) {
            const callPromise = this.assetGroupSignalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateAssetGroupSignals(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     */
    close() {
        if (this.assetGroupSignalServiceStub && !this._terminated) {
            return this.assetGroupSignalServiceStub.then(stub => {
...
exports.AssetGroupSignalServiceClient = AssetGroupSignalServiceClient;
//# sourceMappingURL=asset_group_signal_service_client.js.map