 ...
 * `src/v11/invoice_service_client_config.json`.
...
class InvoiceServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.InvoiceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.invoiceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.InvoiceService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.InvoiceService, this._opts, this._providedCustomServicePath);
     ...
     */
    close() {
        if (this.invoiceServiceStub && !this._terminated) {
