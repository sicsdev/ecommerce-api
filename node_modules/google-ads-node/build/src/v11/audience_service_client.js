 ...
 * `src/v11/audience_service_client_config.json`.
...
class AudienceServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.AudienceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.audienceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.AudienceService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.AudienceService, this._opts, this._providedCustomServicePath);
    ...
    mutateAudiences(request, optionsOrCallback, callback) {
        ...
        this.initialize();
        return this.innerApiCalls.mutateAudiences(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
     ...
     */
    close() {
        if (this.audienceServiceStub && !this._terminated) {
            return this.audienceServiceStub.then(stub => {
...
exports.AudienceServiceClient = AudienceServiceClient;
//# sourceMappingURL=audience_service_client.js.map