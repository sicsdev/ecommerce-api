 ...
 * `src/v11/conversion_value_rule_service_client_config.json`.
...
class ConversionValueRuleServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.ConversionValueRuleService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionValueRuleServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.ConversionValueRuleService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.ConversionValueRuleService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversionValueRuleServiceStubMethods = ['mutateConversionValueRules'];
     ...
     */
    close() {
        if (this.conversionValueRuleServiceStub && !this._terminated) {
