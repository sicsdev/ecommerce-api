...
exports.AudienceInsightsServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v11/audience_insights_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./audience_insights_service_client_config.json");
...
class AudienceInsightsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.AudienceInsightsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.audienceInsightsServiceStub) {
            return this.audienceInsightsServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v11.services.AudienceInsightsService.
        this.audienceInsightsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.AudienceInsightsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.AudienceInsightsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const audienceInsightsServiceStubMethods = ['generateInsightsFinderReport', 'listAudienceInsightsAttributes', 'generateAudienceCompositionInsights'];
        for (const methodName of audienceInsightsServiceStubMethods) {
            const callPromise = this.audienceInsightsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    generateInsightsFinderReport(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    listAudienceInsightsAttributes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    generateAudienceCompositionInsights(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.AudienceInsightsServiceClient = AudienceInsightsServiceClient;
//# sourceMappingURL=audience_insights_service_client.js.map