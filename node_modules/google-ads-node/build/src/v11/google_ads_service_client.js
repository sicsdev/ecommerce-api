 ...
 * `src/v11/google_ads_service_client_config.json`.
...
class GoogleAdsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.stream = {
            searchStream: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, opts.fallback === 'rest')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.GoogleAdsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.googleAdsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.GoogleAdsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.GoogleAdsService, this._opts, this._providedCustomServicePath);
