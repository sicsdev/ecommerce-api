 ...
 * `src/v11/ad_group_criterion_label_service_client_config.json`.
...
class AdGroupCriterionLabelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.AdGroupCriterionLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupCriterionLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.AdGroupCriterionLabelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.AdGroupCriterionLabelService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupCriterionLabelServiceStubMethods = ['mutateAdGroupCriterionLabels'];
     ...
     */
    close() {
        if (this.adGroupCriterionLabelServiceStub && !this._terminated) {
