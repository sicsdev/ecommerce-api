 ...
 * `src/v11/customer_negative_criterion_service_client_config.json`.
...
class CustomerNegativeCriterionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.CustomerNegativeCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerNegativeCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.CustomerNegativeCriterionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.CustomerNegativeCriterionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerNegativeCriterionServiceStubMethods = ['mutateCustomerNegativeCriteria'];
     ...
     */
    close() {
        if (this.customerNegativeCriterionServiceStub && !this._terminated) {
