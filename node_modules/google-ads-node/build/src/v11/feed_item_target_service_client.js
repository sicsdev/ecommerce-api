 ...
 * `src/v11/feed_item_target_service_client_config.json`.
...
class FeedItemTargetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.FeedItemTargetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.feedItemTargetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.FeedItemTargetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.FeedItemTargetService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const feedItemTargetServiceStubMethods = ['mutateFeedItemTargets'];
     ...
     */
    close() {
        if (this.feedItemTargetServiceStub && !this._terminated) {
