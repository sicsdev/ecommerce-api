 ...
 * `src/v11/keyword_plan_campaign_keyword_service_client_config.json`.
...
class KeywordPlanCampaignKeywordServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.KeywordPlanCampaignKeywordService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanCampaignKeywordServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.KeywordPlanCampaignKeywordService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.KeywordPlanCampaignKeywordService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordPlanCampaignKeywordServiceStubMethods = ['mutateKeywordPlanCampaignKeywords'];
     ...
     */
    close() {
        if (this.keywordPlanCampaignKeywordServiceStub && !this._terminated) {
