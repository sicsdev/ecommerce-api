 ...
 * `src/v11/conversion_custom_variable_service_client_config.json`.
...
class ConversionCustomVariableServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.ConversionCustomVariableService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionCustomVariableServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.ConversionCustomVariableService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.ConversionCustomVariableService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversionCustomVariableServiceStubMethods = ['mutateConversionCustomVariables'];
     ...
     */
    close() {
        if (this.conversionCustomVariableServiceStub && !this._terminated) {
