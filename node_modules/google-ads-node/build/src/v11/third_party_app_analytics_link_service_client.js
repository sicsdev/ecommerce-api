 ...
 * `src/v11/third_party_app_analytics_link_service_client_config.json`.
...
class ThirdPartyAppAnalyticsLinkServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.ThirdPartyAppAnalyticsLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.thirdPartyAppAnalyticsLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.ThirdPartyAppAnalyticsLinkService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.ThirdPartyAppAnalyticsLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const thirdPartyAppAnalyticsLinkServiceStubMethods = ['regenerateShareableLinkId'];
