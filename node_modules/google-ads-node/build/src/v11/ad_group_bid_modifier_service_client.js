 ...
 * `src/v11/ad_group_bid_modifier_service_client_config.json`.
...
class AdGroupBidModifierServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.AdGroupBidModifierService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupBidModifierServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.AdGroupBidModifierService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.AdGroupBidModifierService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupBidModifierServiceStubMethods = ['mutateAdGroupBidModifiers'];
     ...
     */
    close() {
        if (this.adGroupBidModifierServiceStub && !this._terminated) {
