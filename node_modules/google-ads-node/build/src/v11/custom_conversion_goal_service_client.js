 ...
 * `src/v11/custom_conversion_goal_service_client_config.json`.
...
class CustomConversionGoalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.CustomConversionGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customConversionGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.CustomConversionGoalService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.CustomConversionGoalService, this._opts, this._providedCustomServicePath);
     ...
     */
    close() {
        if (this.customConversionGoalServiceStub && !this._terminated) {
