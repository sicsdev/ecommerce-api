 ...
 * `src/v11/ad_group_extension_setting_service_client_config.json`.
...
class AdGroupExtensionSettingServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.AdGroupExtensionSettingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupExtensionSettingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.AdGroupExtensionSettingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.AdGroupExtensionSettingService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const adGroupExtensionSettingServiceStubMethods = ['mutateAdGroupExtensionSettings'];
     ...
     */
    close() {
        if (this.adGroupExtensionSettingServiceStub && !this._terminated) {
