 ...
 * `src/v11/experiment_arm_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./experiment_arm_service_client_config.json");
...
class ExperimentArmServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.ExperimentArmService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.experimentArmServiceStub) {
            return this.experimentArmServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v11.services.ExperimentArmService.
        this.experimentArmServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.ExperimentArmService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.ExperimentArmService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const experimentArmServiceStubMethods = ['mutateExperimentArms'];
        for (const methodName of experimentArmServiceStubMethods) {
            const callPromise = this.experimentArmServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateExperimentArms(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.mutateExperimentArms(request, options, callback);
    }
    // --------------------
    // -- Path templates --
    // --------------------
     ...
     */
    close() {
        if (this.experimentArmServiceStub && !this._terminated) {
            return this.experimentArmServiceStub.then(stub => {
...
//# sourceMappingURL=experiment_arm_service_client.js.map