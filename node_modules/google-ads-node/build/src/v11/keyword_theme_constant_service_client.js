 ...
 * `src/v11/keyword_theme_constant_service_client_config.json`.
...
class KeywordThemeConstantServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.KeywordThemeConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordThemeConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.KeywordThemeConstantService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.KeywordThemeConstantService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const keywordThemeConstantServiceStubMethods = ['suggestKeywordThemeConstants'];
     ...
     */
    close() {
        if (this.keywordThemeConstantServiceStub && !this._terminated) {
