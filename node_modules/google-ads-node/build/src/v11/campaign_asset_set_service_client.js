 ...
 * `src/v11/campaign_asset_set_service_client_config.json`.
...
class CampaignAssetSetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.CampaignAssetSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.CampaignAssetSetService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.CampaignAssetSetService, this._opts, this._providedCustomServicePath);
     ...
     */
    close() {
        if (this.campaignAssetSetServiceStub && !this._terminated) {
