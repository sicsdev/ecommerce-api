 ...
 * `src/v11/payments_account_service_client_config.json`.
...
class PaymentsAccountServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v11.services.PaymentsAccountService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.paymentsAccountServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v11.services.PaymentsAccountService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v11.services.PaymentsAccountService, this._opts, this._providedCustomServicePath);
     ...
     */
    close() {
        if (this.paymentsAccountServiceStub && !this._terminated) {
