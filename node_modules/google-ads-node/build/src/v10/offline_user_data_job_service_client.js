 ...
 * `src/v10/offline_user_data_job_service_client_config.json`.
...
class OfflineUserDataJobServiceClient {
    ...
    constructor(opts) {
        ...
        const runOfflineUserDataJobMetadata = protoFilesRoot.lookup('.google.ads.googleads.v10.resources.OfflineUserDataJobMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v10.services.OfflineUserDataJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.offlineUserDataJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v10.services.OfflineUserDataJobService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v10.services.OfflineUserDataJobService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const offlineUserDataJobServiceStubMethods = ['createOfflineUserDataJob', 'addOfflineUserDataJobOperations', 'runOfflineUserDataJob'];
