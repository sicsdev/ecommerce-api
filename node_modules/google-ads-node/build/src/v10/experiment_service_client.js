 ...
 * `src/v10/experiment_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./experiment_service_client_config.json");
...
class ExperimentServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listExperimentAsyncErrors: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'errors')
        };
        ...
        const scheduleExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const scheduleExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v10.services.ScheduleExperimentMetadata');
        const promoteExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const promoteExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v10.services.PromoteExperimentMetadata');
        this.descriptors.longrunning = {
            scheduleExperiment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, scheduleExperimentResponse.decode.bind(scheduleExperimentResponse), scheduleExperimentMetadata.decode.bind(scheduleExperimentMetadata)),
            promoteExperiment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, promoteExperimentResponse.decode.bind(promoteExperimentResponse), promoteExperimentMetadata.decode.bind(promoteExperimentMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v10.services.ExperimentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.experimentServiceStub) {
            return this.experimentServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v10.services.ExperimentService.
        this.experimentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v10.services.ExperimentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v10.services.ExperimentService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const experimentServiceStubMethods = ['mutateExperiments', 'endExperiment', 'listExperimentAsyncErrors', 'graduateExperiment', 'scheduleExperiment', 'promoteExperiment'];
        for (const methodName of experimentServiceStubMethods) {
            const callPromise = this.experimentServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    mutateExperiments(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    endExperiment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    graduateExperiment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    scheduleExperiment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkScheduleExperimentProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.scheduleExperiment, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    promoteExperiment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkPromoteExperimentProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.promoteExperiment, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listExperimentAsyncErrors(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listExperimentAsyncErrorsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        return this.descriptors.page.listExperimentAsyncErrors.createStream(this.innerApiCalls.listExperimentAsyncErrors, request, callSettings);
    }
    /**
     ...
     */
    listExperimentAsyncErrorsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listExperimentAsyncErrors.asyncIterate(this.innerApiCalls['listExperimentAsyncErrors'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=experiment_service_client.js.map