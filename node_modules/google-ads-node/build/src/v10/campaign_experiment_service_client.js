 ...
 * `src/v10/campaign_experiment_service_client_config.json`.
...
class CampaignExperimentServiceClient {
    ...
    constructor(opts) {
        ...
        const createCampaignExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v10.services.CreateCampaignExperimentMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v10.services.CampaignExperimentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignExperimentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v10.services.CampaignExperimentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v10.services.CampaignExperimentService, this._opts, this._providedCustomServicePath);
