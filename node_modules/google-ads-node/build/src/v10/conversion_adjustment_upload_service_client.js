 ...
 * `src/v10/conversion_adjustment_upload_service_client_config.json`.
...
class ConversionAdjustmentUploadServiceClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v10.services.ConversionAdjustmentUploadService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionAdjustmentUploadServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v10.services.ConversionAdjustmentUploadService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v10.services.ConversionAdjustmentUploadService, this._opts, this._providedCustomServicePath);
     ...
     */
    close() {
        if (this.conversionAdjustmentUploadServiceStub && !this._terminated) {
