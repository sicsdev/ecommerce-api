...
declare type Query = `${SelectClause}${FromClause}${WhereClause}${OrderClause}${LimitClause}`;
...
export declare function extractConstraintConditions(constraints: ReportOptions["constraints"]): ConstraintString[];
...
export declare function buildWhereClause(constraints: ReportOptions["constraints"], dateConstant: ReportOptions["date_constant"], fromDate: ReportOptions["from_date"], toDate: ReportOptions["to_date"]): WhereClause;
...
export declare function buildOrderClauseOld(orderBy: ReportOptions["order_by"], sortOrder: ReportOptions["sort_order"], entity: ReportOptions["entity"]): OrderClause;
export declare function buildOrderClauseNew(order: Required<ReportOptions["order"]>, entity: ReportOptions["entity"]): OrderClause;
export declare function buildOrderClause(order: ReportOptions["order"], orderBy: ReportOptions["order_by"], sortOrder: ReportOptions["sort_order"], entity: ReportOptions["entity"]): OrderClause;
export declare function buildRequestOptions(reportOptions: ReportOptions): RequestOptions;
export declare function buildQuery(reportOptions: ReportOptions): {
    gaqlQuery: Query;
