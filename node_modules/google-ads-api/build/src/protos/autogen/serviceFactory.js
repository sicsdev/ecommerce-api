...
class ServiceFactory extends service_1.Service {
    ...
    get campaignExperiments() {
        ...
        return {
             ...
             */
            update: async (campaignExperiments, options) => {
                const ops = this.buildOperations("update", campaignExperiments, 
                // @ts-expect-error Static class type here is fine
             ...
             * @returns services.MutateCampaignExperimentsResponse
             */
            remove: async (campaignExperiments, options) => {
                const ops = this.buildOperations("remove", campaignExperiments);
                const request = this.buildRequest(ops, options);
                const baseHookArguments = {
                    credentials: this.credentials,
                    method: "CampaignExperimentService.mutateCampaignExperiments",
             ...
             */
            graduateCampaignExperiment: async (request) => {
                const baseHookArguments = {
                    credentials: this.credentials,
             ...
             */
            promoteCampaignExperiment: async (request) => {
                const baseHookArguments = {
                    credentials: this.credentials,
             ...
             */
            endCampaignExperiment: async (request) => {
                const baseHookArguments = {
                    credentials: this.credentials,
             ...
             */
            listCampaignExperimentAsyncErrors: async (request) => {
                const baseHookArguments = {
                    credentials: this.credentials,
    ...
    get keywordPlans() {
        ...
        return {
             ...
             */
            generateForecastCurve: async (request) => {
                const baseHookArguments = {
                    credentials: this.credentials,
             ...
             */
            generateForecastTimeSeries: async (request) => {
                const baseHookArguments = {
                    credentials: this.credentials,
             ...
             */
            generateForecastMetrics: async (request) => {
                const baseHookArguments = {
                    credentials: this.credentials,
             ...
             */
            generateHistoricalMetrics: async (request) => {
                const baseHookArguments = {
                    credentials: this.credentials,
    ...
    get reachPlans() {
        ...
        return {
             ...
             */
            generateProductMixIdeas: async (request) => {
                const baseHookArguments = {
                    credentials: this.credentials,
